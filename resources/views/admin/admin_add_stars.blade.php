...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Dodaj Gwiazde</li>
</ol>
@endsection

@section('content')

<div class="w-100 h-50 text-center"><h1> Dodaj Nową Gwiazdę </h1></div>
...
<div class="conatainer" style="padding-top: 10px; padding-bottom: 20px;">
    ...
    <div class="form-group">
        ...
        <label class="custom-file-label @error('thumbnail_stars') form-error @enderror" for="thumbnail_stars" style="text-align: left">Wybierz Zdjęcie</label>
    ...
    <div class="form-group">
        <div class="input-group">
            <input type="text" class="form-control @error('stars_name') form-error @enderror" id="stars_name" name="stars_name" placeholder="Imie i nazwisko Gwiazdy">
            <span class="input-group-append">
                <button class="btn btn-outline-secondary border-left-0 border" type="button" onclick="document.getElementById('stars_name').value = ''">
        ...
        $(document).ready(function() {
            $('#thumbnail_stars').on('input', function() {
            var name = document.getElementById("thumbnail_stars").value.replace(/^.*[\\\/]/, '').replace(/\.[^/.]+$/, "");
            var change = $("input[name='stars_name']");
            change.val(name);  
        ...
        <div class="form-group">
            ...
            @enderror
                ...
                <div class="form-group">
        <label for="rating">Ocena Gwiazdy:</label><br>
