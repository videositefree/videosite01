...
@section('title')VideoSite Dodaj Wytwórnię @endsection

@section('direction')
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ url('/admin_studios') }}">Wytwórnie</a></li>
    <li class="breadcrumb-item active" aria-current="page">Dodaj Wytwórnię</li>
</ol>
@endsection
...
<div class="upload-page">
    ...
    <h1 class="upload-page__title">Dodaj nową wytwórnię</h1>
            ...
            <form action="{{url('/save_studios')}}" method="POST" enctype="multipart/form-data" id="add_films">
                ...
                <section class="upload-section">
                    ...
                    <div class="custom-file mb-3">
                        ...
                        <label class="custom-file-label @error('thumbnail_studios') form-error @enderror" for="thumbnail_studios">Wybierz zdjęcie</label>
                    </div>
                ...
                <section class="upload-section">
                    ...
                    <div class="input-group" style="margin-bottom: 14px;">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" onclick="document.getElementById('studios_name').value = ''">
                ...
                <section class="upload-section">
                    ...
                    <div class="upload-subgroup">
                        <label class="upload-subgroup__label">Tagi wytwórni</label>
