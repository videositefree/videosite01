...
<div class="col-sm-12 text-center" style="padding-bottom: 10px;">
    <ul>
      <h2>Zarządzaj Kopiami Folderów Thumbnail</h2>
      <a class="btn btn-outline-primary fas fa-folder-open fa-film" href="{{url('/open_main_folder_thumbnail_copy')}}" style="margin-bottom: 20px;"> ZDJĘCIA </a>
    </ul>
  </div>
...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete_all">Usuń Wszystkie Kopię Bazy Danych</button>
  <a href="{{url('/copy_folder')}}" class="btn btn-success">Wykonaj Kopię Folderu thumbnail</a>
</div>
...
<!------------------------------------------------------------------Modal-------------------------------------------------------------------->
  ...
  <div class="modal fade"  id="delete_{{$file->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content modtext" >
        ...
        Kopia folderu thumbnail zostanie usunięta. </b>Pamiętaj że decyzji nie można cofnąć</b>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-success" data-dismiss="modal">Anuluj</button>
          <a class="btn btn-danger" href="{{url('/delete_folder_copy', $file->name)}}">Usuń</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade"  id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content modtext" >
        ...
        Wszystkie kpie zostaną permanentnie usunięte z dysku twardego. </b>Pamiętaj że decyzji nie można cofnąć</b>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-success" data-dismiss="modal">Anuluj</button>
          <a class="btn btn-danger" href="{{url('/delete_folder_copy_all')}}">Usuń</a>
        </div>
      </div>
    </div>
  </div>
