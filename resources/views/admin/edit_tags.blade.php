...
<div class="conatainer" style="padding-top: 10px; padding-bottom: 20px;">
    ...
    <div>
      ...
      <form action="{{url('/edit_tags_save')}}" method="POST" enctype="multipart/form-data" id="add_films">
      ...
      <a class="btn btn-outline-secondary fas fa-folder-open" href="{{url('/open_folder_tags', $tags->id)}}" style="margin-bottom: 20px;"> Główny folder z tagami</a>
        ...
        <div class="form-group">
          <div class="input-group"> 
            ...
            <div class="input-group-append">
                <a class="btn btn-outline-secondary fas fa-folder-open" href="{{url('/open_folder_tags_next', $tags->id)}}" ></a>   
            </div>
            @error('tags_name')
