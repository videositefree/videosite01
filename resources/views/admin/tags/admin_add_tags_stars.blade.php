...
@section('direction')
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ url('/admin_tags_stars') }}">Kategorie</a></li>
...
<div class="upload-page">
    ...
    <h1 class="upload-page__title">Dodaj nowy tag dla gwiazd</h1>
    ...
    <div class="upload-layout">
        ...
        <div class="upload-form-wrap">
            <form action="{{url('/save_tags_stars')}}" method="POST" enctype="multipart/form-data" id="add_films">
                @csrf
                ...
                <section class="upload-section">
                    ...
                    <div class="custom-file mb-3">
                        ...
                        <label class="custom-file-label @error('thumbnail_tags') form-error @enderror" for="thumbnail_tags">Wybierz zdjęcie</label>
                    </div>
                ...
                <section class="upload-section">
                    <h2><span class="upload-step">2</span> Nazwa</h2>
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-outline-secondary" type="button" onclick="document.getElementById('tags_name').value = ''">
                ...
                <section class="upload-section">
                    <h2><span class="upload-step">3</span> Rozmiar zdjęcia</h2>
