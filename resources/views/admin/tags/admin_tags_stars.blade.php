...
<div class="admin-page">
    ...
    <div class="admin-page__header">
        <h1 class="admin-page__title">Tagi gwiazd</h1>
        <div class="admin-quicklinks">
            <a class="admin-quicklink" href="{{url('/open_main_folder_tags_stars')}}">
    ...
    @if( $count_tags > 0 )
        ...
        <div class="admin-toolbar">
            ...
            <div class="admin-toolbar__actions">
                ...
                <a href="{{url('/add_tags_stars')}}" class="btn btn-success">+ Dodaj nowy tag</a>
            </div>
        </div>
            ...
            <table class="table">
                    ...
                    <tr>
                        <th scope="col" style="width: 8%">
                            <div class="th-sort">#
                                <span class="th-sort__arrows">
                                    <a href="{{url('/admin_tags_stars')}}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M18 15l-6-6-6 6"/></svg></a>
                                    <a href="{{url('/tags_id_asc_admin_stars_stars')}}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M6 9l6 6 6-6"/></svg></a>
                                </span>
                            </div>
                        </th>
                        <th scope="col" style="width: 45%">
                            <div class="th-sort">Nazwa
                                <span class="th-sort__arrows">
                                    <a href="{{url('/tags_name_asc_admin_stars')}}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M18 15l-6-6-6 6"/></svg></a>
                                    <a href="{{url('/tags_name_desc_admin_stars')}}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M6 9l6 6 6-6"/></svg></a>
                                </span>
                            </div>
                        </th>
                ...
                @foreach($tags as $key => $tag)
                    <tr>
                        ...
                        <td class="table_site">
                            <a href="{{ url('/select_categories_stars', $tag->id) }}">
                                <b>{{$tag->name}}</b>
                        ...
                        <td>
                            <a href="{{url('/edit_tags_stars', $tag->id)}}" class="btn btn-info">Edytuj</a>
                            <a class="btn btn-danger" href="{{url('/delete_files_from_admin_search_tags_stars', $tag->id)}}">Usuń</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modtext">
            ...
            <div class="modal-footer">
                <a class="btn btn-danger" href="{{url('/delete_all_tags_stars')}}">Usuń</a>
