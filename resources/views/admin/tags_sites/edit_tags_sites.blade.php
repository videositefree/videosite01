...
@section('direction')
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{ url('/admin_tags_sites') }}">Kategorie</a></li>
...
<div class="conatainer" style="padding-top: 10px; padding-bottom: 20px;">
    ...
    <div>
      ...
      <form action="{{url('/edit_tags_sites_save')}}" method="POST" enctype="multipart/form-data" id="add_films">
      ...
      <a class="btn btn-outline-secondary fas fa-folder-open" href="{{url('/open_folder_tags_sites', $tags->id)}}" style="margin-bottom: 20px;"> Główny folder z tagami</a>
   
        <div class="form-group">
          <div class="input-group"> 
            <input type="text" class="form-control @error('sites_name') form-error @enderror" name="tags_name" placeholder="Nazwa Tagu" value="{{$tags->name}}">
            <div class="input-group-append">
                <a class="btn btn-outline-secondary fas fa-folder-open" href="{{url('/open_folder_tags_next_sites', $tags->id)}}" ></a>   
            </div>
            @error('tags_name')
