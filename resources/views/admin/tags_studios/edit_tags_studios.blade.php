...
<div class="upload-page">
    ...
    <div class="upload-layout">
        ...
        <div class="upload-form-wrap">
            <form action="{{url('/edit_tags_studios_save')}}" method="POST" enctype="multipart/form-data" id="edit_tags_main">
                @csrf
                ...
                <section class="upload-section">
                    ...
                    <a class="admin-quicklink" href="{{url('/open_folder_tags_studios', $tags->id)}}" style="margin-bottom: 16px; display:inline-flex;">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <a class="btn btn-outline-secondary fas fa-folder-open" href="{{url('/open_folder_tags_next_studios', $tags->id)}}" title="Otwórz folder"></a>
                            </div>
                        </div>
